...
dependencies beyond Python 3.11's standard library. It refuses symlinks and
source paths outside the repository, and will not read source files larger than
10 MiB.
